...
<body>
  ...
  $allData = mysqli_query($conn, "SELECT * FROM `register` WHERE student_id='$l_id'");
                ...
                <div class='card-body'>
                  <div class='d-flex flex-column align-items-center text-center'>
                    ...
                    <div class='mt-3'>
                      ...
                      <a href='upload.php?id=$row[id]'><button class='btn btn-success'>Change photo</button></a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class='col-md-8 mt-'>
              <div class='card mb-3'>
                <div class='card-body'>
                  ...
                  <div class='row'>
                    <div class='col-sm-12'>
                    <a href='studentUpdate.php?id=$row[id]'><button class='btn btn-info px-4 ms-3'>Update Info</button></a>
