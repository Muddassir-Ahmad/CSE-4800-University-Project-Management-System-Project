...
<head>
    ...
    <title>UPMS-Schedule Upload</title>
                    ...
                    <header>
                        ...
                        <div class="position-sticky">
                            <div class="list-group list-group-flush mx-3 mt-4">
                                <a href="Admin_Panel/adminPanel.php" class="list-group-item list-group-item-action py-2 ripple"
                                    aria-current="true">
                                ...
                                <a href="Admin_Panel/studentData.php" class="list-group-item list-group-item-action py-2 ripple"><i
                                        class="fas fa-lock fa-fw me-3"></i><span>Students</span></a>
                                <a href="Admin_Panel/proposalData.php" class="list-group-item list-group-item-action py-2 ripple"><i
                                ...
                                <a href="Admin_Panel/feedback.php" class="list-group-item list-group-item-action py-2 ripple"><i
                                        class="fas fa-chart-bar fa-fw me-3"></i><span>Feedback</span></a>
                                <a href="Admin_Panel/assignSupervisor.php"
                                    class="list-group-item list-group-item-action py-2 ripple"><i
                                        class="fas fa-globe fa-fw me-3"></i><span>Assign Supervisor</span></a>
                                <a href="Admin_Panel/noticeUpload.php" class="list-group-item list-group-item-action py-2 ripple"><i
                                ...
                                <a href="Admin_Panel/reqUpload.php" class="list-group-item list-group-item-action py-2 ripple"><i
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-5 col-md-6 ">
                            ...
                            <div class="card my-5">
                                ...
                                <form action="scheduleUpAction.php" method="post"
                                    class=" card-body cardbody-color p-lg-5" enctype="multipart/form-data">
                                    <h2 class="text-center text-dark mt-2 mb-5">Upload Schedule</h2>
                                    ...
                                    <div class="mb-3">
                                        <select class="form-control" name="p_code" required>
                                            ...
                                            <option value="CSE-4800">CSE-4801</option>
                                    ...
                                    <div class="mb-3">
                                        <input type="file" name="s_pdf" class="form-control" required>
                                    </div>
                                    <br>
                                    <br>
