    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center mt-4">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                ...
                <form action="insertProposal4.php" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                    ...
                    <div class="mb-2">
                        ...
                        <h5 class="text-center bg-warning p-1"> INFORMATION OF MEMBER: 1 </h5>
                    ...
                    <div class="mb-2 mt-2">
                        <!-- <h4 class="">Team Details</h4> -->
                        <h5 class="text-center bg-warning p-1"> INFORMATION OF MEMBER: 2 </h5>
                        <!-- <input type="text" class="form-control" name="p_member" required> -->
                    </div>
                    ...
                    <div class="mb- mt-2">
                        <!-- <h4 class="">Team Details</h4> -->
                        <h5 class="text-center bg-warning p-1"> INFORMATION OF MEMBER: 3 </h5>
                        <!-- <input type="text" class="form-control" name="p_member" required> -->
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="mb-1">
                                Name :
                                <input type="text" class="form-control" name="s3_name" required>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="mb-1">
                                ID :
                                <input type="text" class="form-control" name="s3_id" required>
                            </div>
                        </div>
                    </div>
                    <!-- 3rd member 1st row end -->
                    ...
                    <div class="mb- mt-2">
                        <!-- <h4 class="">Team Details</h4> -->
                        <h5 class="text-center bg-warning p-1"> INFORMATION OF MEMBER: 4 </h5>
                        <!-- <input type="text" class="form-control" name="p_member" required> -->
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="mb-1">
                                Name :
                                <input type="text" class="form-control" name="s4_name" required>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="mb-1">
                                ID :
                                <input type="text" class="form-control" name="s4_id" required>
                            </div>
                        </div>
                    </div>
                    <!-- 4th member 1st row end -->
