...
<head>
    ...
    <title>UPMS-Requirement Upload</title>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8 col-md-6 ">
                            ...
                            <div class="card my-5">
                                ...
                                <form action="reqUploadAction.php" method="post" class=" card-body cardbody-color p-lg-5" enctype="multipart/form-data">
                                    <h2 class="text-center text-dark mt-2">Requirement Upload</h2>
                                    ...
                                    <div class="mb-1">
                                        <select class="form-control" name="c_code" required>
                                    ...
                                    <div class="mb-3">
                                        <input type="text" name="t_description" class="form-control py-5" placeholder="Topic Details" required>
                                    </div>
                                    <div class="mb-3">
