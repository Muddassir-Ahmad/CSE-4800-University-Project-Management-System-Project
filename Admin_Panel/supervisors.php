...
<head>
    ...
    <title>UPMS-Supervisor Data</title>
                    ...
                    <table class="table table-white table-striped table-hover">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Total Studend Assigned</th>
                        ...
                        <tbody>
                            ...
                            <?php
                            include '../config.php';
                            $allData = mysqli_query($conn, "SELECT DISTINCT assigned FROM `proposal` where NOT assigned='NOT ASSIGNED'");
