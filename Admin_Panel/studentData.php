            ...
            <div class="col-lg-10 col-md-12">
                ...
                <div class="">
                    <div class="row justify-content-center ">
                        <h1 class="mb-5 mt-3  ">Student Data</h1>
                ...
                <div class="container" style="margin-left:-20px; border-style: solid; width:fit-content;">
                    <table class="table table-white table-striped table-hover">
                        ...
                        <td><a class='btn btn-warning' href='studentApprove.php? id=$row[id]'>Approve</a></td>
                        <td><a class='btn btn-danger' href='studentDelete.php? id=$row[id]'>Delete</a></td>
