        ...
        <div class="row mt-5">
            ...
            <div class="col-lg-10 col-md-12">
                ...
                <div class="">
                    ...
                    <h1 class="mb-5 mt-3">Assign Supervisor</h1>
                ...
                <div class="container " style="margin-left:-20px; border-style: solid; width:fit-content;">
                    ...
                    <th scope="col">Delete</th> -->
                                ...
                                <th hidden scope="col">Delete Proposal</th>
                            </tr>
                        </thead>
                        <tbody>
                        ...
                        <td><a class='btn btn-warning' href='assign.php? id=$row[id]'>Assign</a></td>
                        <td><a hidden class='btn btn-danger' href='delete.php? id=$row[id]'>Delete</a></td>
