...
<body>
    ...
    <div class="container  border-dark mt-4" style="margin-left: 100px;">

<div class="row mb-4">
    <div class="col-lg-6 col-md-12">
        <div class="card shadow-lg ">
            <a href="one.php" class="text-decoration-none text-dark">
                <div class="d-flex">
                    <img class="card-img-top m-5" style="width: 10vw;height: 10vw;" src="./img/people1.png" alt="Card image cap">
                    <div class="card-body m-auto">
                        <h3 class="card-title">Team With one Member</h3>
                    </div>
                </div>
            </a>
        </div>
    ...
    <div class="col-lg-6 col-md-12">
        <div class="card shadow-lg ">
            <a href="two.php" class="text-decoration-none text-dark">
                <div class="d-flex">
                    <img class="card-img-top m-5" style="width: 10vw;height: 10vw;" src="./img/people2.png" alt="Card image cap">
                    <div class="card-body m-auto">
                        <h3 class="card-title">Team With Two Members</h3>
                    </div>
                </div>
            </a>
        </div>
...
<div class="row mb-4">
    <div class="col-lg-6 col-md-12">
        <div class="card shadow-lg ">
            <a href="three.php" class="text-decoration-none text-dark">
                <div class="d-flex">
                    <img class="card-img-top m-5" style="width: 10vw;height: 10vw;" src="./img/people3.jpg" alt="Card image cap">
                    <div class="card-body m-auto">
                        <h3 class="card-title">Team With Three Members</h3>
                    </div>
                </div>
            </a>
        </div>
    ...
    <div class="col-lg-6 col-md-12">
        <div class="card shadow-lg ">
            <a href="four.php" class="text-decoration-none text-dark">
                <div class="d-flex">
                    <img class="card-img-top m-5" style="width: 10vw;height: 10vw;" src="./img/people4.png" alt="Card image cap">
                    <div class="card-body m-auto">
                        <h3 class="card-title">Team With Four Members</h3>
                    </div>
                </div>
            </a>
        </div>
