        ...
        <div class="row mb-5 justify-content-center ">
            <div class="col-lg-5 col-md-12">
                <div class="card shadow-lg ">
                    <a href="result3300.php" class="text-decoration-none text-dark">
                        <div class="d-flex">
                            <img class="card-img-top my-5 mx-4" style="width: 12vw; height: 12vw;" src="img/resultt.jpeg"
                                alt="Card image cap">
                            <div class="card-body m-auto">
                                <h3 class="card-title">Project Result</h3>
                                <h5>CSE-3300</h5>
            ...
            <div class="col-lg-5 col-md-12">
                <div class="card shadow-lg ">
                    <a href="result4800.php" class="text-decoration-none text-dark">
                        <div class="d-flex">
                            <img class="card-img-top my-5 mx-4" style="width: 12vw;height: 12vw;" src="img/resultt.jpeg"
                                alt="Card image cap">
                            <div class="card-body m-auto">
