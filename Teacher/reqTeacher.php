...
<head>
    ...
    <title>UPMS-Project Requirement</title>
...
<body>
    ...
    <div class="container-fluid mt-2">
        <div class="row border border-danger py-2 bg-dark">
            <div class="col-12">
                <h1 class="text-white text-center">Project | Requirements</h1>
            </div>
        </div>
    </div>
 ...
 <?php
    ...
    $allData = mysqli_query($conn, "SELECT * FROM `requirement` ORDER BY id DESC");
    ...
    while ($row = mysqli_fetch_array($allData)) {
        echo "
                ...
                <div class='row d-flex justify-content-center'>
                    ...
                    <h3 class='mt-3 mb-2'><b>$row[c_code]</b></h3>
                    <h6 class='mt-3 mb-2'><b>Uploaded Date:$row[time]</b></h6>

                    <h3 class='mt-3 mb-2'><b>Topic:$row[t_name]</b></h3>
                                
                         
                    <span><h6 class='d-inline-block mb-3'>$row[t_details]</h6></span><br>
                        ...
                        <div class='card p-3 py-4 '>
                            ...
                            <div class='text-center mt-3'>
                                ...
                                <img src='$row[t_image]' width='100%' height='100%'>
