...
<body>
    ...
    <!--------------------------- Headings ------------------->
        ...
        <div class=" container-fluid mt-4">
            <div class="row border border-danger py-2 bg-dark">
                <div class="col-12">
                    <h2 class="text-white text-center">Students | Department of CSE</h2>
                </div>
            </div>
        </div>
        ...
        <?php
        include '../config.php';
        $allData = mysqli_query($conn, "SELECT * FROM `register`WHERE department='CSE'");
    ...
    <div class='center d-inline-block text-center'>
       ...
       <img src='../$row[image]'width='100px' height='100px' class='tim my-3'  alt=''> 
        ...
        <div class="container-fluid mt-4">
            <div class="row border border-danger py-2 bg-dark">
                <div class="col-12">
                    <h2 class="text-white text-center">Students | Department of EEE</h2>
                </div>
            </div>
        </div>
        ...
        <?php
        include '../config.php';
        $allData = mysqli_query($conn, "SELECT * FROM `register`WHERE department='EEE'");
