...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="dropdown nav-item">
                    ...
                    <li class="nav-item ">
                        <a hidden class="nav-link text-dark" href="../about.php">About</a>
                    </li>
                    <li class="nav-item">
  ...
  <tbody>
    ...
    <td class='fs-4'>$row[s4_name]</td>
                              ...
                              <a href='task2.php?id=$row[id]'><button class='btn btn-info px-4 ms-3'>Assign Task</button></a>
                            
                                  <a href='../admin/pdfshow.php?id=$row[id]'><button class='btn btn-info px-4 ms-3'>Proposal</button></a>
                          ...
                          <h5 class='fs- text-center text-danger'>1:$row[task] </h5>
